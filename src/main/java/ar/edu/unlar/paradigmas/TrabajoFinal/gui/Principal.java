...
import ar.edu.unlar.paradigmas.TrabajoFinal.gui.forms.Gestion.GestionMotivo;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Motivo");

        jMenuItemMotivo.setText("ABM Motivos");
    ...
    private void jMenuItemMotivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemMotivoActionPerformed
        GestionMotivo gestionMotivo = new GestionMotivo();
        desktopPane.add(gestionMotivo);
        gestionMotivo.setVisible(true);
